...
class CoralsModels(CoralModelsInterface):
    ...
    def fit_corals_detection(
        ...
        Args:
            img (Iterable): iterable of images as matrices (e.g. images opened with PIL).
            start_from_pretrained: if True, training will start from the last
            model trained. If False, a brand new model will be created.

            annot (Iterable): iterable containing iterables of annotations, one for each image. 
            Each annotation contains a fragment's category (acropora, bleached, etc...) 
            as well as its bounding box's coordinates on 
    ...
    def detect_corals(
        ...
        Returns:
            a list containing annotations for each image. 
            Each annotation contains a fragment's category (acropora, 
    ...
    def detect_structure(
        ...
        Returns:
            a list of masks corresponding to each image as arrays
        """
        pass
